...
<main class="flex flex-col flex-1 p-4">
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14 px-4">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-18">
            <h1 class="font-semibold text-3xl sm:text-4xl lg:text-5xl">Hi! I'm <span class="text-violet-400">Asheque</span> Mahmood<br>Full Stack <span class="poppins text-violet-400">Developer</span></h1>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400">favorite</span> tech includes JavaScript (React or SvelteKit), TailwindCSS, Node.js + Express.js, Deno + Hono, PostgreSQL + MongoDB or Firebase</p>
            <a href="#" target="_blank" class="blueShadow bg-white text-slate-950 py-3 px-6 rounded-full overflow-hidden poppins relative mx-auto lg:ml-0 text-base sm:text-lg md:text-xl">
        ...
        <div class="relative shadow-2xl grid place-items-center">
            <img src={"images/fotor.jpg"} alt="" class="object-cover z-[2] max-h-[35vh] sm:max-h-[50vh] lg:max-h-[60vh] rounded-full">
        </div>
